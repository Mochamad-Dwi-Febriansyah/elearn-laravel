...
class CommunicateController extends Controller
{
    ...
    public function InsertNoticeBoard(Request $request){
        ...
        return redirect('admin/communicate/notice_board')->with('success', 'Notice Board successfullt created');
    }
    ...
    public function UpdateNoticeBoard($id, Request $request){
        ...
        return redirect('admin/communicate/notice_board')->with('success', 'Notice Board successfullt updated'); 
    }
    public function DeleteNoticeBoard($id){
        ...
        NoticeBoardMessageModel::DeleteRecord($id);
        return redirect()->back()->with('success', 'Notice Board successfullt deleted'); 
    }
