                  ...
                  <tbody> 
                    @forelse ($getRecord as $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('teacher/material/material/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                                <a href="{{ url('teacher/material/material/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
