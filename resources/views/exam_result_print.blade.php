...
<body>
    <div id="page">
        <table style="width: 100%; text-align: center;">
            <tr>
                <td width="5%"></td>
                <td width="15%"><img style="width: 88px" src="{{ $getSetting->getLogo() }}" alt=""></td>
                <td align="left">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td width="20%" valign="top">
                    <img src="{{ $getStudent->getProfileDirect() }}" alt="" style="border-radius: 6px;" height="100px" width="100px">
                    <br>
