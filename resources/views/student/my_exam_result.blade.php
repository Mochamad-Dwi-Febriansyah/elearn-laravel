        ...
        <div class="row">  
            ...
            @foreach ($getRecord as $value)    
                ...
                <div class="card">
                    ...
                    <a href="{{ url('student/my_exam_result/print?exam_id='.$value['exam_id'].'&student_id='.Auth::user()->id) }}" target="_blank" class="btn btn-primary btn-sm" style="float: right">Print</a>
                    </div> 
