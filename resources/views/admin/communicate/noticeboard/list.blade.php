                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="date" class="form-control" name="notice_date_from" value="{{ Request::get('notice_date_form') }}">
                    </div> 
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="date" class="form-control" name="publish_date_from" value="{{ Request::get('publish_date_form') }}">
                    </div> 
                    <div class="form-group col-md-2">
